...
local playerGui = game:GetService("Players").LocalPlayer.PlayerGui:WaitForChild("ScreenGui")
...
action:addListener(InputHandler:getType("MouseButton1"), true, false, false, {Enum.UserInputState.Begin})
action:addListener(InputHandler:getType("L"), true, false, false, {Enum.UserInputState.Begin})
